...
function [chicken_health, food_eaten, number_of_nodes_visited] = foraging_known_food(n, time, food_source, starting_chicken_health, food_amount)
    ...
    while time_gone < time && chicken_health > 1  % While there is still time left and chicken is still in health
       ...
       source = chicken_position
       targets = food_position
       d = distances(G, source, targets, 'Method','unweighted')
