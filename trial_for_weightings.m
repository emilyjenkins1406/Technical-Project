...
for dominance_hierachy = 0:1
        ...
        for runs = 1:50
            ...
            [positions_chickens, percentage_eating, dead, min_health, variance, moving_on] = foraging_known_food_weights(graphing, dominance_hierachy, chickens, n, time, food_source, starting_chicken_health, food_amount);
...
%% MAKING  A TABLE
model = ["Known food + weights"; "Known food and Hierachy + weights"];
